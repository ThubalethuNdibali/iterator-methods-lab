...
console.log(veryOldInventors); // [true, 'string', 42]
...
const isAdultPresent = devs.some(person =>  20 >= person.age );
...
const legalAgeYear = currentYear - 19;
...
// Enter your solution code here:
const commentById = comments.find (comments => comments.id === 823423);
